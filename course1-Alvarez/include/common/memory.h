 ...
 *
 * Take a pointer to a source memory location, a length in 
 * bytes and set all locations of that memory to a given value.
 *
 * @param src Pointer to source
 * @param lenght Number of bytes
 * @param value To set location
 *
 * @return pointer
 */
...
/**
 * @brief Set all locations of that memory to a zero value.
 *
 * Take a pointer to a memory location, a length in bytes and zero out all 
 * of the memory. memory to a given value.
 *
 * @param src Pointer to source
 * @param lenght Number of bytes
 *
...
/**
 * @brief Free a dynamic memory.
 *
 * Free a dynamic memory allocation by providing the pointer src to the 
 * function
 *
 * @param src Pointer to source
 *
